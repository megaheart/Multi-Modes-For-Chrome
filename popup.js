    ...
    switchModeOn(mode) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.currentModeBinding) {
                ...
                close_tabIds = [];
                let tabs = yield chrome.tabs.query({});
...
class ModeBinding {
    ...
    switchModeOn() {
        this.group.querySelector(".switch-mode-on").disabled = true;
        this.group.querySelector(".import").disabled = true;
    ...
    switchModeOff() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.group.querySelector(".switch-mode-on").disabled = false;
            this.group.querySelector(".import").disabled = false;
